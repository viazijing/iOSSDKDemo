...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="rtc",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC3rtc17ConferenceManager")
...
@interface ConferenceManager (SWIFT_EXTENSION(rtc)) <NSURLSessionWebSocketDelegate>
...
SWIFT_CLASS("_TtC3rtc19PresentationManager")
...
@interface PresentationManager (SWIFT_EXTENSION(rtc)) <RTCVideoCapturerDelegate>
...
@interface PresentationManager (SWIFT_EXTENSION(rtc)) <RTCPeerConnectionDelegate>
...
SWIFT_CLASS("_TtC3rtc10RTCManager")
...
@interface RTCManager (SWIFT_EXTENSION(rtc)) <RTCVideoCapturerDelegate>
- (void)capturer:(RTCVideoCapturer * _Nonnull)capturer didCaptureVideoFrame:(RTCVideoFrame * _Nonnull)frame;
@end
...
SWIFT_CLASS("_TtC3rtc22RTCScreenVideoCapturer")
